													...
													<>
														...
														<div className="ml-2 flex shrink-0 gap-1 opacity-0 transition-opacity group-hover:opacity-100">
															...
															<button
																...
																className="rounded px-1.5 py-0.5 text-[10px] font-mono text-cz-light-blue hover:bg-cz-inset"
																onClick={(e) => {
																	e.stopPropagation();
															...
															<button
																type="button"
																title="Delete preset"
																className="rounded px-1.5 py-0.5 text-[10px] font-mono text-red-400 hover:bg-cz-inset"
																onClick={(e) => {
																	e.stopPropagation();
