const _wasm_bindgen = ((exports) => {
	...
	if (Symbol.dispose)
		CzSynthProcessor.prototype[Symbol.dispose] =
			CzSynthProcessor.prototype.free;
	exports.CzSynthProcessor = CzSynthProcessor;

	function __wbg_get_imports() {
		const import0 = {
			__proto__: null,
			__wbg___wbindgen_copy_to_typed_array_a4db337751e0b328: (
				arg0,
				arg1,
				arg2,
			) => {
			...
			__wbg_error_38bec0a78dd8ded8: (arg0) => {
		...
		return {
			__proto__: null,
			"./cz_synth_bg.js": import0,
		};
	}

	const CzSynthProcessorFinalization =
		typeof FinalizationRegistry === "undefined"
			? { register: () => {}, unregister: () => {} }
			: new FinalizationRegistry((ptr) =>
					wasm.__wbg_czsynthprocessor_free(ptr >>> 0, 1),
				);
